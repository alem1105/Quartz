  ...
  _Esempio:_
  Provare che $$\frac{n}{\log_e n}\inΩ(\sqrt{n}\log_en)$$
...
Nel nostro caso otteniamo:$$\lim_{n\rightarrow+\infty}\frac{\sqrt{n}}{\log^2n}=+\infty$$ Ricordando che la radice cresce più velocemente del logaritmo
